...
<div id="preloader">
    ...
    <div class="bg-homeBg dark:bg-homeTwoBg-dark min-h-screen bg-no-repeat bg-center bg-cover bg-fixed md:pb-16 w-full bg-[url('https://bostamihtml.ibthemespro.com/images/background/bg.jpg')]">
                ...
                <div
                    ...
                    <div class="pt-[100px] pb-8">
                        ...
                        <button class="dowanload-btn">
                            <img class="mr-3" src="https://bostamihtml.ibthemespro.com/images/icons/dowanload.png" alt="icon" /> Download CV </button>
                    </div>
                </div>
            </div>
                ...
                <header
                    ...
                    <nav class="hidden lg:block">
                        <ul class="flex">
                            ...
                            <li>
                                <router-link class="menu-item" :to="{name: 'resume'}">
                                    <span class="text-xl mb-1">
                                        <i class="fa-regular fa-user"></i>
                                    </span> Resume
                                </router-link>
                            ...
                            <li>
                                <router-link class="menu-item" :to="{name: 'works'}">
                                    <span class="text-xl mb-1">
                                        <i class="fa-regular fa-user"></i>
                                    </span> Works
                                </router-link>
                            ...
                            <li>
                                <router-link class="menu-item" :to="{name: 'blog'}">
                                    <span class="text-xl mb-1">
                                        <i class="fa-regular fa-user"></i>
                                    </span> Blog
                                </router-link>
