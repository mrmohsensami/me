<template>
    ...
    <section id="portfolio" class="bg-white   lg:rounded-2xl dark:bg-[#111111]">
                      <div class="container  mb-8 px-4 sm:px-5 md:px-10 lg:px-[60px]">
                          ...
                          <div id="isotop-gallery-wrapper" class="mymix portfolio_list-two  two-col " style="position: relative; height: 1738.45px;">
                              <div class="grid-sizer"></div>
                              <!-- portfolio items one start -->
                              <div class="portfolio_list-two-items isotop-item plugin custom " style="position: absolute; left: 0%; top: 0px;">
                                  <div class="rounded-lg bg-[#fff0f0] p-6 dark:bg-transparent dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloOne" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/1.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                              ...
                              <div id="portfiloOne" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/1.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item dev branding " style="position: absolute; left: 50%; top: 0px;">
                                  <div class="rounded-lg bg-[#fff3fc] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloTwo" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/2.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                              ...
                              <div id="portfiloTwo" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/2.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 308px;">
                                  <div class="rounded-lg bg-[#fff3fc] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloThree" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/3.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                                      <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">UI/UX</span>
                                      <h2 class="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-white mt-2">
                              ...
                              <div id="portfiloThree" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/3.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item dev custom " style="position: absolute; left: 50%; top: 406px;">
                                  <div class="rounded-lg p-6 bg-[#e9faff] dark:bg-transparent dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloFour" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/4.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                                      <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">UI/UX</span>
                                      <h2 class="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-white mt-2">
                              ...
                              <div id="portfiloFour" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/4.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 0%; top: 666px;">
                                  <div class="rounded-lg bg-[#fffae9] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloFive" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/5.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                              ...
                              <div id="portfiloFive" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/5.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 50%; top: 812px;">
                                  <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloSix" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/6.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                              ...
                              <div id="portfiloSix" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/6.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 1023px;">
                                  <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloSeven" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/7.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                                      <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">Video</span>
                                      <h2 class="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-white mt-2">
                              ...
                              <div class="portfolio_list-two-items isotop-item dev branding " style="position: absolute; left: 50%; top: 1218px;">
                                  <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloEight" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/8.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                                      <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">Video</span>
                                      <h2 class="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-white mt-2">
                              ...
                              <div id="portfiloEight" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/8.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
                              ...
                              <div class="portfolio_list-two-items isotop-item plugin custom " style="position: absolute; left: 0%; top: 1381px;">
                                  <div class="rounded-lg bg-[#fff0f8] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                                      <div class="overflow-hidden rounded-lg">
                                          <a href="#portfiloNine" rel="modal:open">
                                              <img class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto" src="https://bostamihtml.ibthemespro.com/images/work_images/small/9.jpg" alt="portfolio image">
                                          </a>
                                      </div>
                                      <span class="pt-5 text-[14px] font-normal text-gray-lite block dark:text-[#A6A6A6]">Web
                                          Design</span>
                              ...
                              <div id="portfiloNine" class="modal-container modal">
                                  <div class="overflow-y-scroll scroll-hide-1700  max-h-[60vh] lg:max-h-[80vh] dark:scrollbarDark scrollbarLight">
                                      ...
                                      <div class="pr-3">
                                          <img class="w-full md:h-[450px] h-auto object-cover rounded-xl mt-6" src="https://bostamihtml.ibthemespro.com/images/work_images/9.jpg" alt="portfolio image">
                                      </div>
                                  </div>
                                  <a href="#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark">Close</a>
                              </div>
